            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('excavator', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>excavator</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('excavator', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/excavators/view/${record.excavator?.id}`}>
                          {record.excavator?.name}
                        </Link>
                      </Td>
                    )}
